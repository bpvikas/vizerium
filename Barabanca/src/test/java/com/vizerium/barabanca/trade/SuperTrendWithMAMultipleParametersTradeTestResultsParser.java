...
public class SuperTrendWithMAMultipleParametersTradeTestResultsParser extends MultipleParametersTradeTestResultsParser {
	...
	protected String getTestResultsDirectoryPath() {
		return FileUtils.directoryPath + "output-log-v2/supertrend-with-ma/";
	}
	...
	protected String getParsedResultsFile() {
		return FileUtils.directoryPath + "output-log-v2/supertrend-with-ma-parsed-results/supertrendWithMAParsedResults_v0.csv";
	}

	public static void main(String[] args) {
		SuperTrendWithMAMultipleParametersTradeTestResultsParser parser = new SuperTrendWithMAMultipleParametersTradeTestResultsParser();
