...
public class BearCaseMinimumLossPayoffMatrixComparator implements Comparator<OptionsWithPayoff> {

	@Override
	public int compare(OptionsWithPayoff o1, OptionsWithPayoff o2) {
		return Comparator.comparing(OptionsWithPayoff::getBearCaseMinNegativePayoff).compare(o2, o1);
	}
}
